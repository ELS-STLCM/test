...
namespace SimChartMedicalOffice.Web.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public ActionResult LogOn()
        {
            ...
            if (AppCommon.IsDevEnvironment())
            {
                string domainUsername = System.Security.Principal.WindowsIdentity.GetCurrent().Name;
                if (domainUsername.Contains("ITLINFOSYS"))
                {
                    string userName = domainUsername.Replace("ITLINFOSYS\\", "");
        ...
        public ActionResult TinyMCEPOC()
        {
            return View();
        }
        public ActionResult TestDropBox()
        {
            return View();
        }
